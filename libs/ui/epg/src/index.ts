...
export * from './lib/follow-series-button/follow-series-button.component';
export * from './lib/followed-series/followed-series.component';
export * from './lib/followed-series/followed-series-overlay.component';
export * from './lib/followed-series/followed-series-view.util';
...
export * from './lib/multi-epg/multi-epg-program-dialog';
