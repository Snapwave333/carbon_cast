...
pubDate: 2026-05-14
author: 4gray
heroImage: /carbon_cast/screenshots/external-player-support-mpv.webp
tags:
    - playback
    - external-players
    - diagnostics
...
<BlogImageSlider
    images={[
        ...
        {
            src: '/carbon_cast/blog/external-players/playback-diagnostics-v0-22.jpg',
...
<BlogImageSlider
    images={[
        {
            src: '/carbon_cast/blog/external-players/diagnostics-anatomy-v0-22.jpg',
...
<BlogImageSlider
    images={[
        {
            src: '/carbon_cast/blog/external-players/external-player-handoff.jpg',
