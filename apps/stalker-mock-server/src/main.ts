...
/**
 * CORS proxy compatibility endpoint — mirrors the CarbonCast IPTV backend API shape:
 *   GET /stalker?url=<portal_url>&macAddress=<mac>&action=<action>&...
 *   → { payload: <stalker_response> }
 *
 * The CarbonCast IPTV PWA sends Stalker requests to AppConfig.BACKEND_URL/stalker.
