...
| --------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------- |
| Workspace shell and top navigation dock | [`libs/workspace/shell/`](./libs/workspace/shell/)                                                                                         | [`workspace-shell.md`](./docs/architecture/workspace-shell.md)                                                |
...
| Free-channel catalogue and merging      | [`libs/playlist/shared/util/src/lib/channel-sources/`](./libs/playlist/shared/util/src/lib/channel-sources/), [`tools/channel-sources/`](./tools/channel-sources/) | [`channel-source-catalog.md`](./docs/architecture/channel-source-catalog.md)                                  |
...
| SQLite and worker operations            | [`libs/shared/database/`](./libs/shared/database/), [`apps/electron-backend/src/app/database/`](./apps/electron-backend/src/app/database/) | [`sqlite-db-worker.md`](./docs/architecture/sqlite-db-worker.md) — FTS plus live 72-hour media-query cache    |
...
| MCP, CLI, and live automation           | [`apps/agent-control/`](./apps/agent-control/), [`apps/mcp-server/`](./apps/mcp-server/), [`apps/iptvctl/`](./apps/iptvctl/)               | [`agent-control.md`](./docs/architecture/agent-control.md) — playback, lifecycle, display, and window control |
